                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('kategori', $produk->kategori) }}"
                                        class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">{{ $produk->kategori->name }}</a>
                                </div>
                            </li>
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $produk->name }}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                                ...
                                <div class="relative mb-6 lg:mb-10 group">
                                    ...
                                    @if ($produk->on_sale)
                                        <div class="absolute top-4 left-4">
                                            <span
                                                class="px-3 py-1.5 text-xs font-medium tracking-wider text-white uppercase bg-red-600 rounded-full">Sale</span>
                                        </div>
                                    @endif
                                </div>
                                ...
                                @if ($produk->images && count($produk->images) > 1)
                                    <div class="flex-wrap hidden gap-2 md:flex">
                                        @foreach ($produk->images as $image)
                                            <div class="w-1/4 p-1">
                                                <img src="{{ url('storage/' . $image) }}" alt="Thumbnail"
                                ...
                                <div class="px-6 pb-6 mt-6 border-t border-gray-200 dark:border-gray-700">
                                    <div class="flex flex-wrap items-center mt-4 space-y-2 md:space-y-0">
                                        ...
                                        <div class="flex items-center w-full gap-2 md:w-1/3">
                                            ...
                                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Quality
                                                Guarantee</span>
                                        </div>
                                        ...
                                        <div class="flex items-center w-full gap-2 md:w-1/3">
                                            ...
                                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Easy
                                                Returns</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-8">
                                    <div class="flex flex-wrap items-center mb-6">
                                        ...
                                        <div class="flex flex-wrap ml-auto">
                                            @if ($produk->on_sale)
                                                <span
                                                    class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-100 text-red-800 mr-2">
                                            ...
                                            @if ($produk->is_featured)
                                                <span
                                                    class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-100 text-blue-800 mr-2">
                                                    <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg"
                                                        width="16" height="16" fill="currentColor"
                                                        viewBox="0 0 16 16">
                                                        <path
                                    ...
                                    <a href="{{ route('kategori', $produk->kategori) }}"
                                        class="inline-block mb-4 text-lg font-semibold text-blue-600 transition-colors duration-300 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                                    ...
                                    <div class="mb-6">
                                        <h3 class="mb-2 text-lg font-semibold text-gray-800 dark:text-white">Deskripsi
                                        </h3>
                                    ...
                                    <div class="flex items-center mt-6">
                                        <span class="mr-4 text-sm font-medium text-gray-600 dark:text-gray-400">Kontak
                                            Kami :</span>
                                        <div class="flex space-x-2">
                                            <a href="https://wa.me/6285810200320"
                                            ...
                                            <a href="https://www.instagram.com/lestariadv5235"
                                                class="text-gray-500
                                                hover:text-pink-600 dark:text-gray-400 dark:hover:text-pink-400">
                                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                                                    aria-hidden="true">
                                                    <path fill-rule="evenodd"
                                            ...
                                            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                                                <li class="mr-2">
                                                    <button @click="activeTab = 'description'"
                                                        :class="{ 'border-b-2 border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-400': activeTab === 'description', 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300': activeTab !== 'description' }"
                        ...
                        <div class="mt-16">
                            ...
                            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                                @forelse($relatedProducts ?? [] as $related)
                                    <div
                                        class="overflow-hidden transition-shadow duration-300 bg-white shadow-lg rounded-xl dark:bg-gray-700 group hover:shadow-xl">
                                        <a href="{{ route('produk.detail', $related) }}"
                                            class="relative block h-64 overflow-hidden">
                                            <img src="{{ $related->image_url ?? url('storage/' . $related->images[0]) }}"
                                                alt="{{ $related->name }}"
                                                class="object-cover w-full h-full transition-transform duration-300 group-hover:scale-105">
                                            @if ($related->on_sale)
                                                <span
                                                    class="absolute px-3 py-1 text-sm font-semibold text-white bg-red-500 rounded-lg top-3 left-3">Sale</span>
                                            @endif
                                        </a>

                                        <div class="p-6">
                                            <a href="{{ route('kategori', $related->kategori) }}"
                                                class="text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                                                {{ $related->kategori->name }}
                                            </a>

                                            <a href="{{ route('produk.detail', $related) }}"
                                                class="block mt-3 text-xl font-semibold text-gray-800 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 line-clamp-2">
                                                {{ $related->name }}
                                            </a>
                                            ...
                                            <div class="flex items-center justify-between mt-6">
                                                <div>
                                                    <span
                                                        class="text-xl font-bold text-green-600 dark:text-green-400">Rp{{ number_format($related->harga, 0, ',', '.') }}</span>
                                                </div>

                                                <button type="button" wire:click="addToCart({{ $related->id }})"
                                                    class="p-3 text-white transition-all duration-200 bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
                                ...
                                @empty
                                    <div class="col-span-3 py-16 text-center">
                                        <div class="max-w-md mx-auto">
                                            ...
                                            <h3 class="mb-2 text-lg font-medium text-gray-900 dark:text-white">Tidak
                                                ada produk terkait</h3>
                                            <p class="text-gray-500 dark:text-gray-400">Produk terkait belum tersedia
                                                saat ini.</p>
                                        </div>
                                    </div>
                                @endforelse
