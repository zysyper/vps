    ...
    <div class="absolute top-0 left-0 w-full overflow-hidden leading-none">
        <svg class="relative block w-full h-12" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
                ...
                class="text-gray-100 fill-current"></path>
        </svg>
    </div>
        ...
        <div class="grid grid-cols-1 gap-8 mb-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center mb-6 space-x-3">
                    <div class="p-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl">
                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M4 3a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 12.846 4.632 15 6.414 15H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 5H6.28l-.31-1.243A1 1 0 005 3H4zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                        </svg>
                    </div>
                    <div>
                        <h3
                            class="text-2xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text">
                            Lestari Adv
                        </h3>
                ...
                <div class="flex space-x-4">
                    <a href="https://wa.me/6285810200320"
                        class="p-3 transition-all duration-300 transform rounded-lg group bg-slate-700 hover:bg-green-600 hover:scale-110">
                        <svg class="w-5 h-5 text-slate-300 group-hover:text-white" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="https://www.instagram.com/lestariadv5235"
                        class="p-3 transition-all duration-300 transform rounded-lg group bg-slate-700 hover:bg-red-600 hover:scale-110">
                        <svg class="w-5 h-5 text-slate-300 group-hover:text-white" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
            ...
            <div>
                ...
                @foreach ($kategoris as $kategori)
                    <ul class="space-y-3">
                        <li><a
                                class="flex items-center transition-colors duration-200 text-slate-300 hover:text-blue-400 group">
                                <span
                                    class="w-2 h-2 mr-3 transition-transform bg-blue-500 rounded-full group-hover:scale-125"></span>
                                {{ $kategori->name }}
                            </a></li>
                    </ul>
                @endforeach
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-3 group">
                        <a href="https://maps.app.goo.gl/Hv7DaQCbfDF1o1Jx6" target="_blank" rel="noopener noreferrer"
                            class="p-2 transition-colors duration-200 rounded-lg cursor-pointer bg-slate-700 group-hover:bg-blue-600">
                            <svg class="w-4 h-4 text-slate-300 group-hover:text-white" fill="currentColor"
                                viewBox="0 0 20 20">
                        ...
                        <div>
                            <p class="text-sm leading-relaxed text-slate-300">
                                Santa Modern Market Jalan Cisanggiri <br> Blok AKS no 158 Kebayoran Baru Lantai dasar
                                aks 158,
                    ...
                    <div class="flex items-center space-x-3 group">
                        <div
                            class="p-2 transition-colors duration-200 rounded-lg bg-slate-700 group-hover:bg-green-600">
                            <svg class="w-4 h-4 text-slate-300 group-hover:text-white" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
            ...
            <div class="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
                <div class="flex flex-col items-center space-y-2 md:flex-row md:space-y-0 md:space-x-6">
                    <p class="text-sm text-slate-400">
                        © 2015 LestariAdv. All rights reserved.
                    </p>
                    <div class="flex space-x-6 text-sm">
                        ...
                        <a href="https://maps.app.goo.gl/SXaVCVZpiNmt7ZrEA"
                            class="transition-colors text-slate-400 hover:text-white">Sitemap</a>
                    </div>
                </div>
                ...
                <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})"
                    ...
                    <svg class="w-5 h-5 transition-all duration-200 transform text-slate-300 group-hover:text-white group-hover:-translate-y-1"
