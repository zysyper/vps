        ...
        <div class="container px-4 py-8 mx-auto">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="relative mb-8 overflow-hidden bg-white shadow-xl rounded-2xl">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 opacity-90">
                    </div>
                            ...
                            <div class="mb-6 lg:mb-0">
                                <div class="flex items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-xl text-blue-100">Order
                            ...
                            <div class="p-8">
                                <div class="space-y-6">
                                    @foreach ($order_items as $index => $item)
                                        <div
                                            class="relative p-6 transition-all duration-300 border border-gray-200 rounded-xl hover:shadow-lg hover:border-indigo-300 group">
                                            <div class="absolute top-4 right-4">
                                                <span
                                                    class="inline-flex items-center justify-center w-8 h-8 text-sm font-semibold text-indigo-600 bg-indigo-100 rounded-full">
                                                    {{ $index + 1 }}
                                                </span>
                                            </div>
                                            ...
                                            <div class="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-6">
                                                ...
                                                <div class="flex-shrink-0">
                                                    ...
                                                    @else
                                                        <div
                                                            class="flex items-center justify-center w-24 h-24 transition-colors bg-gray-200 md:w-32 md:h-32 rounded-xl group-hover:bg-gray-300">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex items-center">
                                                                        <svg class="w-4 h-4 mr-1" fill="none"
                                                                            ...
                                                                            <path stroke-linecap="round"
                                                                                stroke-linejoin="round" stroke-width="2"
                                                                                d="M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2h4a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1h2z">
                                                                            </path>
                                                                        </svg>
                                                                        Qty: {{ $item->quantity }}
                                                                    </div>
                        ...
                        <div class="overflow-hidden bg-white shadow-xl rounded-2xl">
                            ...
                            <div class="p-8">
                                <div class="relative">
                                    ...
                                    <div
                                        class="absolute left-4 top-6 bottom-6 w-0.5 @if ($order->status == 'canceled') bg-red-300 @else bg-gray-200 @endif">
                                    </div>
                                    <div class="space-y-6">
                                        <!-- Order Created -->
                                        <div class="relative flex items-start">
                                            <div
                                                class="z-10 flex items-center justify-center w-8 h-8 bg-green-100 border-2 border-green-500 rounded-full">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <p class="text-gray-600">{{ $order->created_at->format('d F Y, H:i') }}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        @if ($order->status == 'canceled')
                                            ...
                                            <div class="relative flex items-start">
                                                <div
                                                    class="z-10 flex items-center justify-center w-8 h-8 bg-red-100 border-2 border-red-500 rounded-full shadow-lg">
                                                    <!-- Stylish X Icon -->
                                                    <svg class="w-4 h-4 text-red-500 transition-transform duration-200 transform hover:scale-110"
                                                ...
                                                <div class="ml-4">
                                                    ...
                                                    <p class="text-gray-600">
                                                        {{ $order->updated_at->format('d F Y, H:i') }}</p>
                                                    @if (isset($order->cancellation_reason))
                                                        <div
                                                            class="inline-block px-3 py-1 mt-2 border border-red-200 rounded-lg bg-red-50">
                                                            <p class="text-sm font-medium text-red-600">Alasan:
                                        ...
                                        @else
                                            ...
                                            @if (in_array($order->status, ['processing', 'shinpped', 'delivered'])) bg-blue-100 border-blue-500 @else bg-gray-100 border-gray-300 @endif">
                                                    ...
                                                    <div class="ml-4">
                                                        <h3 class="text-lg font-semibold text-gray-900">Sedang Diproses
                                                        </h3>
                                            ...
                                            @if (in_array($order->status, ['shinpped', 'delivered']))
                                                <div class="relative flex items-start">
                                                    <div
                                                        class="z-10 flex items-center justify-center w-8 h-8 bg-purple-100 border-2 border-purple-500 rounded-full">
                                                    ...
                                                    <div class="ml-4">
                                                        <h3 class="text-lg font-semibold text-gray-900">Pesanan Dikirim
                                                        </h3>
                                            ...
                                            @if ($order->status == 'delivered')
                                                <div class="relative flex items-start">
                                                    ...
                                                    <div class="ml-4">
                                                        <h3 class="text-lg font-semibold text-gray-900">Pesanan Selesai
                                                        </h3>
                            ...
                            <div class="p-6 space-y-6">
                                <div class="flex items-center justify-between p-4 rounded-xl bg-gray-50">
                                    <div>
                                        ...
                                        <span
                                            class="inline-flex items-center px-3 py-1 mt-1 text-xs font-medium rounded-full
                                ...
                                @if ($order->original_name)
                                    <div class="p-4 rounded-xl bg-gray-50">
                                        ...
                                        <a class="mt-1 text-blue-900"
                                            href="{{ Storage::url($order->file_path) }}">{{ $order->original_name }}</a>
                                    </div>
                                @endif
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between py-3 border-b border-gray-100">
                                        ...
                                        <span class="font-semibold text-gray-900">Rp
                                            {{ number_format($order_items->sum('total_amount'), 0, ',', '.') }}</span>
                                    </div>
                        ...
                        <div class="p-8 bg-white shadow-xl rounded-2xl">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center p-4 bg-blue-50 rounded-xl">
                                    ...
                                    <span class="font-medium text-blue-900">bilnet@gmail.com</span>
                                </div>
                                <div class="flex items-center p-4 bg-green-50 rounded-xl">
                                    ...
                                    <span class="font-medium text-green-900">+62 858-1020-0320</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-8 bg-white shadow-xl rounded-2xl">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="p-3 rounded-lg bg-blue-50">
                                    <p class="text-sm text-blue-800">🚚 Jika ingin Menggunakan Jasa Pengiriman, Hubungi
                                        Kami di WhatsApp untuk Informasi Lebih Lanjut</p>
                                </div>
                            </div>
                        </div>
                    </div>
